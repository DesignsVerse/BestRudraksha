...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.bestrudraksha.com/checkout",
    siteName: "BestRudraksha.com",
    images: [
      {
        url: "https://www.bestrudraksha.com/images/checkout-og-image.jpg", // Checkout vibe ki photo daal
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://www.bestrudraksha.com/images/checkout-twitter-image.jpg"], // Photo daal
    site: "@BestRudraksha", // Apna Twitter handle daal ya hata de
  },
  alternates: {
    canonical: "https://www.bestrudraksha.com/checkout",
  },
  other: {
    "geo.region": "IN",
    "geo.placename": "India",
