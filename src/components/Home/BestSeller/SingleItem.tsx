...
const SingleItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group">
      {/* Added white margin with padding */}
      <div className="p-4 bg-white rounded-lg">
        <div className="relative overflow-hidden rounded-lg bg-[#800000] bg-opacity-10 min-h-[403px]">
          ...
          <div className="absolute left-0 bottom-0 w-full flex flex-col gap-2 p-5.5 ease-linear duration-300 group-hover:translate-x-0">
            <button
              onClick={() => {
              ...
              id="bestOne"
              className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 text-dark bg-white hover:text-white hover:bg-[#800000]"
            >
              <svg
