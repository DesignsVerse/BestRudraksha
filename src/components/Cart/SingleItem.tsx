        ...
        <div className="min-w-[250px] md:min-w-[400px] flex items-center">
          <div className="flex items-center gap-5 w-full">
            ...
            <div className="flex-1">
              <h3 className="text-base text-dark hover:text-[#800000] transition-colors duration-200">
        ...
        <div className="min-w-[150px] md:min-w-[275px] flex items-center justify-center">
          <div className="flex items-center rounded-md border border-gray-300">
            <button
              ...
              className="flex items-center justify-center w-11 h-11 hover:text-[#800000] transition-colors duration-200 disabled:text-gray-400 disabled:cursor-not-allowed"
            >
              <svg
            ...
            <button
              ...
              className="flex items-center justify-center w-11 h-11 hover:text-[#800000] transition-colors duration-200"
            >
              <svg
                className="fill-current"
                width="20"
