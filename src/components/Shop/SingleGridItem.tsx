...
const SingleGridItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group bg-white p-4 rounded-lg shadow-sm relative">
      {/* Discount Badge */}
      ...
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg bg-[#800000] bg-opacity-5 shadow-1 min-h-[270px] mb-4">
        ...
        <div className="absolute left-0 bottom-0 translate-y-full w-full flex items-center justify-center gap-2.5 pb-5 ease-linear duration-200 group-hover:translate-y-0">
          <button
            ...
            className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 text-dark bg-white hover:bg-[#800000] hover:text-white"
          >
            <svg
          ...
          <button
            ...
            className="inline-flex font-medium text-custom-sm py-[7px] px-5 rounded-[5px] bg-[#800000] text-white ease-out duration-200 hover:bg-[#590000]"
          >
            Add to cart
          </button>
          ...
          <button
            ...
            className={`flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 ${
              isWishlisted ? "bg-[#800000] text-white" : "bg-white text-dark"
            }`}
          >
            <svg
              className="fill-current"
