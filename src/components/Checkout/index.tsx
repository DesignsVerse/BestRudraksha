...
const CheckoutContent = () => {
  ...
  // Billing and Shipping Section JSX
        ...
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <form>
            <div className="flex flex-col lg:flex-row gap-7.5 xl:gap-11">
              {/* Mobile View: Order Section First */}
              ...
              {/* Desktop View: Billing/Shipping First, then Order */}
              <div className="hidden lg:flex lg:flex-row w-full gap-7.5 xl:gap-11">
                <BillingShippingSection />
                <OrderSection />
              </div>
            </div>
...
const Checkout = () => {
  return (
    <Suspense
      fallback={<div className="flex justify-center items-center h-screen">Loading checkout...</div>}
    >
      <CheckoutContent />
    </Suspense>
  );
