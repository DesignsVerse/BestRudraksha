    ...
    <div className="group relative bg-white rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="md:hidden p-4 text-center">
        ...
        <Link
          ...
          className="inline-flex items-center px-4 py-2 text-sm font-semibold text-white bg-[#800000] rounded-full shadow-md hover:bg-[#600000] transition-all duration-300"
        >
          View More
        </Link>
      </div>
