...
const ProductItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group bg-white p-4 rounded-lg shadow-sm relative">
      {/* Discount Badge (Visible on both mobile and desktop) */}
      ...
      <div className="hidden md:block">
        <div className="relative overflow-hidden flex items-center justify-center rounded-lg bg-[#800000] bg-opacity-10 min-h-[270px] mb-4">
          <Image
            src={item.imgs.previews[0]}
            alt={item.title}
            width={250}
          ...
          <div className="absolute left-0 bottom-0 translate-y-full w-full flex items-center justify-center gap-2.5 pb-5 ease-linear duration-200 group-hover:translate-y-0">
            ...
            <button
              ...
              className="inline-flex font-medium text-custom-sm py-[7px] px-5 rounded-[5px] bg-[#800000] text-white ease-out duration-200 hover:bg-[#800000]/90"
            >
              Add to cart
            </button>
