...
const CartSidebarModal = () => {
  ...
  return (
    <div
      className={`fixed top-0 right-0 z-99999 overflow-y-auto no-scrollbar w-full h-screen ease-linear duration-300 ${
        isCartModalOpen ? "translate-x-0" : "translate-x-full"
      }`}
    >
      <div className="flex items-center justify-end">
        <div className="w-full max-w-[500px] shadow-1 bg-white px-4 sm:px-7.5 lg:px-11 relative modal-content h-screen">
