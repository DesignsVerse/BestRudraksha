...
const Footer = () => {
        ...
        <div className="flex  flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li>
                <a href="#" className="flex items-center gap-4.5 hover:text-[#800000] ease-out duration-200">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
            ...
            <div className="flex items-center gap-4 mt-7.5">
              <a
                ...
                className="flex ease-out duration-200 hover:text-[#800000]"
              >
                <svg
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3.5">
              <li>
                <a className="ease-out duration-200 hover:text-[#800000]" href="#">
                  My Account
                </a>
              </li>
              <li>
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3">
              <li>
                <a className="ease-out duration-200 hover:text-[#800000]" href="/privacy-policy">
                  Privacy Policy
                </a>
              </li>
              <li>
                <a className="ease-out duration-200 hover:text-[#800000]" href="/refund-policy">
                  Refund Policy
                </a>
              </li>
              <li>
                <a className="ease-out duration-200 hover:text-[#800000]" href="/terms-of-use">
                  Terms of Use
                </a>
              </li>
              <li>
                <a className="ease-out duration-200 hover:text-[#800000]" href="/faq">
                  FAQ’s
                </a>
              </li>
              <li>
                <a className="ease-out duration-200 hover:text-[#800000]" href="/contact">
                  Contact
                </a>
              </li>
            </ul>
  ...
  <form className="flex flex-col lg:items-end gap-3">
    <input
      type="email"
      placeholder="Enter your email"
      className="py-[9px] px-4 text-custom-sm rounded-md border border-gray-300 bg-white text-dark placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#800000]"
      required
    />
    <button
      type="submit"
      className="inline-flex items-center justify-center py-[9px] px-7.5 text-white rounded-md bg-dark ease-out duration-200 hover:bg-opacity-95 hover:text-[#800000]"
    >
      Subscribe
    </button>
  </form>
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark font-medium">
              © {year}. All rights reserved by DesignsVerse.
            </p>
