        ...
        <div className="flex  flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col lg:items-end gap-3">
              <li>
                <a
                  className="inline-flex items-center gap-3 py-[9px] pl-4 pr-7.5 text-white rounded-md bg-dark ease-out duration-200 hover:bg-opacity-95 hover:text-[#800000]"
                  href="#"
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <a
                  className="inline-flex items-center gap-3 py-[9px] pl-4 pr-8.5 text-white rounded-md bg-dark ease-out duration-200 hover:bg-opacity-95 hover:text-[#800000]"
                  href="#"
                >
                  <svg
                    className="fill-current"
