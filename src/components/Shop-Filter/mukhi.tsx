...
const Mukhi: React.FC = () => {
  ...
  const paginatedProducts = sortedMukhiProducts.slice(startIndex, startIndex + itemsPerPage);
  ...
  return (
    <>
      <Breadcrumb title={"1 - 14 Mukhi Rudraksha"} pages={["1 - 14 Mukhi Rudraksha"]} />
